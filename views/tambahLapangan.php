            ...
            <div class="card-body">
              <form>
                <div class="form-group">
                  <label>Nama</label>
                  <input type="text" placeholder="Nama Lapangan" class="form-control">
                </div>
                ...
                <div class="form-group">       
                  <label>Lokasi</label>
                  <input type="text" placeholder="Lokasi Lapangan" class="form-control">
                </div>
                <div class="form-group">       
                    <label>Deskripsi</label>
                    <textarea class="form-control" placeholder="Deskripsi Lapangan" id="exampleFormControlTextarea1" rows="3"></textarea>
                  </div>
                  ...
                  <div class="input-group mb-2 mr-sm-2">
                    ...
                    <input type="number" class="form-control" id="inlineFormInputGroupUsername2" placeholder="ex : 50000">
                  </div>
                  <div class="form-group">
                ...
                <div class="form-group" style="margin-top: 8px;">       
                  <input type="submit" class="btn btn-warning" value="Tambah" class="btn btn-primary">
