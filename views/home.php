...
<div class="header" style="text-align: center; margin-top: 5%;">
        ...
        <div class="row d-flex justify-content-center" style="margin-top: 1%;">
                ...
                <div class="input-group-prepend mb-3 stroke">
                    <input type="text" class="form-control" placeholder="Cari lapangan" id="search" aria-describedby="basic-addon2">
        ...
        <div class="jumbotron jumbotron-fluid " style="margin-top: -5%;display: block;  height: 500px; background-color: #FFFFFF;">
            <div class="container">
